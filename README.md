...
NOTE: Developed for Minecraft version 1.12.2. It will probably crash (or at the very least, be very hard to predict upsets) if you use post-flattening versions. 
...
- Each player affects a 4 × 4 × 4 group of 16 × 16 × 16 block sections. 
...
# === installation ===
- To begin, you'll need the Minecraft Java Edition (i.e., the launcher on windows) and Java (https://www.java.com/en/download/manual.jsp).
- Install Minecraft 1.12.2 with Forge 14.23.5.2859 (or another Forge version that works with 1.12.2). I got mine from (https://files.minecraftforge.net/net/minecraftforge/forge/index_1.12.2.html)
- You should now be able to install forge by right clicking on the download at "...\Downloads\forge-1.12.2-14.23.5.2859-installer.jar" and opening it with Java. Click through to install client (the default).

- Now, open the Minecraft launcher, it should have a new installaton called "forge" with a subheading along the lines of "1.12.2-forge-14.23.5.2859".
- Hit installations then click the "open installations folder" icon (this takes me to C:\Users\James\AppData\Roaming\.minecraft).
- Put radiation-bit-flip-1.0.0.jar in the mods folder.

- You should now be able to load up a world and play. Press "K" to select the mode.
